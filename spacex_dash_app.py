...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',
                                                ...
                                                marks={i: '{}'.format(i) for i in range(min_payload, max_payload+1, 1000)}
                                                ),
...
def update_pie_chart(selected_site):
    ...
    if selected_site == 'ALL':
        ...
        success_count = site_filtered_df[site_filtered_df['class'] == 1].shape[0]
        failure_count = site_filtered_df[site_filtered_df['class'] == 0].shape[0]
...
def update_scatter_chart(selected_site, payload_range):
    if selected_site == 'ALL':
        ...
        filtered_df = site_filtered_df[(site_filtered_df['Payload Mass (kg)'] >= payload_range[0]) & (site_filtered_df['Payload Mass (kg)'] <= payload_range[1])]
